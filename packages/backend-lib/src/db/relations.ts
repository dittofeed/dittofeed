...
import { workspace, segmentIoConfiguration, userProperty, userPropertyAssignment, emailProvider, secret, emailTemplate, subscriptionGroup, defaultEmailProvider, segment, broadcast, journey, messageTemplate, segmentAssignment, workspaceMemberRole, workspaceMember, workspaceMembeAccount, integration, writeKey, oauthToken, defaultSmsProvider, smsProvider, computedPropertyPeriod, adminApiKey, feature, workspaceRelation } from "./schema";

export const segmentIoConfigurationRelations = relations(segmentIoConfiguration, ({one}) => ({
...
export const userPropertyRelations = relations(userProperty, ({one, many}) => ({
	workspace: one(workspace, {
...
export const userPropertyAssignmentRelations = relations(userPropertyAssignment, ({one}) => ({
	workspace: one(workspace, {
...
export const emailProviderRelations = relations(emailProvider, ({one, many}) => ({
	workspace: one(workspace, {
...
export const subscriptionGroupRelations = relations(subscriptionGroup, ({one, many}) => ({
	workspace: one(workspace, {
...
export const defaultEmailProviderRelations = relations(defaultEmailProvider, ({one}) => ({
	workspace: one(workspace, {
...
export const messageTemplateRelations = relations(messageTemplate, ({one, many}) => ({
	broadcasts: many(broadcast),
	workspace: one(workspace, {
...
export const segmentAssignmentRelations = relations(segmentAssignment, ({one}) => ({
	workspace: one(workspace, {
...
export const workspaceMemberRoleRelations = relations(workspaceMemberRole, ({one}) => ({
	workspace: one(workspace, {
...
export const workspaceMembeAccountRelations = relations(workspaceMembeAccount, ({one}) => ({
	workspaceMember: one(workspaceMember, {
...
export const defaultSmsProviderRelations = relations(defaultSmsProvider, ({one}) => ({
	workspace: one(workspace, {
...
export const computedPropertyPeriodRelations = relations(computedPropertyPeriod, ({one}) => ({
	workspace: one(workspace, {
...
export const workspaceRelationRelations = relations(workspaceRelation, ({one}) => ({
