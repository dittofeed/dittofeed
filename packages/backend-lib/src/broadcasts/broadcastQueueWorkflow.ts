...
export const BROADCAST_QUEUE_WORKFLOW_ID = "broadcast-queue-workflow";

const { defaultWorkerLogger: logger } = proxySinks<LoggerSinks>();

export const addBatchSignal = defineSignal<[string[]]>("addBatchSignal");
...
export interface BroadcastQueueWorkflowParams {
  queueState?: string[];
}
 ...
 */
export async function broadcastQueueWorkflow(
  params: BroadcastQueueWorkflowParams,
) {
  ...
  // //
  // setHandler(addBatchSignal, (workspaceIds: string[]) => {
