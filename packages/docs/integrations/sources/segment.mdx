...
Configure Segment to send its event payloads to your Dittofeed installation, [`POST /api/public/webhooks/segment`](/api-reference/endpoints/webhooks/segment). For example, `https://my-dittofeed-host.com/api/webhooks/segment`.
