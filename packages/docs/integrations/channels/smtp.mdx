...
Note that we don't recommend using SMTP for production email delivery. With a plain SMTP server, you'd lose access to to Spam and Delivery rate metrics, which dedicated email service providers are able to provide via their relationships with ISPs.
