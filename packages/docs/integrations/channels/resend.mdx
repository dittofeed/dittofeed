...
*Note: The "Opened" action can also be used, but it is not recommended as it can drastically reduce deliverability. Additionally, Dittofeed does not currently support the "Delivery Delayed" action.*
