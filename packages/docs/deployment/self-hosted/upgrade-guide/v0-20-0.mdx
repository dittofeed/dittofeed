...
Upgrading from v0.19.0 to v0.20.0 is fairly straightforward, and only requires running postgres migrations. This guide will walk you through the process of upgrading your Dittofeed instance.
...
Or set the `tag` in your `values.yaml` file to `v0.20.0`:
