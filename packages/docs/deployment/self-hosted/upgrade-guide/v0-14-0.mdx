---
title: "Upgrading from v0.13.13 to v0.14.0"
---

Upgrading from v0.13.13 to v0.14.0 is fairly straightforward, and only requires runing postgres migrations. This guide will walk you through the process of upgrading your Dittofeed instance.
...
Upgrade the version in your docker-compose.lite.yaml file to v0.14.0:
