---
title: "Upgrading from v0.11.0 to v0.12.0-alpha.x"
---

<Warning> v0.12.0 is currently in alpha, upgrade at your own risk</Warning>

Upgrading from v0.11.0 to v0.12.0-alpha.x is fairly straightforward, and only requires runing postgres migrations. This guide will walk you through the process of upgrading your Dittofeed instance.
...
services:
  ...
  admin-cli:
    image: dittofeed/dittofeed-lite:${IMAGE_TAG:-v0.12.0-alpha.x}
    entrypoint: []
    profiles: ["admin-cli"]
...
Upgrade the version in your docker-compose.lite.yaml file to v0.12.0-alpha.x:
