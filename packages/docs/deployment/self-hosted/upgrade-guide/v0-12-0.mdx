---
title: "Upgrading from v0.11.0 to v0.12.1"
---

<Warning> v0.12.1 is currently in alpha, upgrade at your own risk</Warning>

Upgrading from v0.11.0 to v0.12.1 is fairly straightforward. This guide will walk you through the process of upgrading your Dittofeed instance.
...
services:
  ...
  admin-cli:
    image: dittofeed/dittofeed-lite:${IMAGE_TAG:-v0.12.1}
    entrypoint: []
    profiles: ["admin-cli"]
...
```bash
./scripts/admin-lite.sh upgrade-0-12-1-pre
```

## Step 4: Upgrade Your `docker-compose.lite.yaml` File

Upgrade the version in your docker-compose.lite.yaml file to v0.12.1:
