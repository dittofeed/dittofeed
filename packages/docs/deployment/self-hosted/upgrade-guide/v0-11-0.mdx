---
title: "Upgrading from v0.10.0 to v0.11.1"
---

Upgrading from v0.10.0 to v0.11.1 is fairly straightforward, and only requires runing postgres migrations. This guide will walk you through the process of upgrading your DittoFeed instance.
...
services:
  ...
  admin-cli:
    image: dittofeed/dittofeed-lite:${IMAGE_TAG:-v0.11.1}
    entrypoint: []
    profiles: ["admin-cli"]
...
Upgrade the version in your docker-compose.lite.yaml file to v0.11.1:
