---
title: "Upgrading from v0.10.0 to v0.11.0"
---

Upgrading from v0.10.0 to v0.11.0 is fairly straightforward, and only requires runing postgres migrations. This guide will walk you through the process of upgrading your DittoFeed instance.
...
Upgrade the version in your docker-compose.lite.yaml file to v0.11.0:
