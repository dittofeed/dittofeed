...
- `kafka`: This mode buffers data in Kafka before writing it to ClickHouse. This mode is useful when you have a high volume of data and want to avoid overwhelming ClickHouse. For more information, see the [Kafka Write Mode page](/deployment/self-hosted/write-modes/kafka.mdx).
