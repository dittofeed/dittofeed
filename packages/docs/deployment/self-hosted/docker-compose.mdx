...
Then, comment out the `ports` section in the service dependencies which don't need to be exposed.
...
Then configure the Dittofeed dashboard to use the new port.
