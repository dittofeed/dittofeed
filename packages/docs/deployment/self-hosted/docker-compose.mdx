...
Note that this will start Postgres, Clickhouse, and Kafka dependencies. You may decide to use a third party vendor for these data stores. In that case, you should disable the corresponding data store in the `docker-compose.prod.yaml` file.