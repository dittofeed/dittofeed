...
{/* --rephrase start-- */}
* one subscription group per channel
* start with opt-out subscribe for email channel
{/* --rephrase end-- */}

## Creating a Subscription Group

{/* --rephrase start-- */}
* navigate to "Subscription Groups"
* press (+) button for new
* edit name
* press save
{/* --rephrase end-- */}
...
### Adding Users to a Subscription Group
...
{/* --rephrase start-- */}
* include code block for relevant track event 
* [Submitting User Events](/guide/submitting-user-events)
{/* --rephrase end-- */}

### Removing Users from a Subscription Group
