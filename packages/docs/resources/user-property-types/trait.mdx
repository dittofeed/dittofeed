...
<mj-text
  ><a
    >href="https://example.com/product/{{ product.id }}">{{ product.name }}</a
  ></mj-text
>
{% endfor %}
```
...
<iframe
  ...
  src="https://www.youtube.com/embed/hD8nDTn-63o?si=k2yoBCIns2RUh_EW"
  title="User Properties | Rendering Trait Properties in Email Templates"
  frameBorder="0"
