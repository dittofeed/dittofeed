...
These features of the secret object are useful for storing sensitive information, such as API keys. API keys for the webhook channel can be set on the settings page.

FIXME screenshot of config and secret table
