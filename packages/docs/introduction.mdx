...
Dittofeed is an open-source, omni-channel customer engagement platform for automating messages to customers via email, SMS, webhooks, and in-app push notifications. Create customer segments, then send them templated onboarding messages, cart abandonment reminders, product updates and more with event-based workflows.
