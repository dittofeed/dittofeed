...
Dittofeed is an open-source, omni-channel customer engagement platform for automating messages to customers via email, SMS, webhooks, and in-app push notifications. Automatically send templated onboarding messages, cart abandonment reminders, product updates and more with event-based triggers and branching logic.
